...
<qgis version="3.28.15-Firenze" hasScaleBasedVisibilityFlag="0" maxScale="0" minScale="1e+08" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" classificationMin="0" type="singlebandpseudocolor" nodataColor="" alphaBand="-1" band="1" classificationMax="100">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader classificationMode="1" colorRampType="INTERPOLATED" minimumValue="0" labelPrecision="4" clip="0" maximumValue="100">
          ...
          <item label="0.0000" color="#ffffb2" alpha="255" value="0"/>
          <item label="25.0000" color="#fecc5c" alpha="255" value="25"/>
          <item label="50.0000" color="#fd8d3c" alpha="255" value="50"/>
          <item label="75.0000" color="#f03b20" alpha="255" value="75"/>
