...
<qgis version="3.28.15-Firenze" hasScaleBasedVisibilityFlag="0" maxScale="0" minScale="1e+08" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" classificationMin="-0.3408884" type="singlebandpseudocolor" nodataColor="" alphaBand="-1" band="1" classificationMax="0.3005275">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader classificationMode="1" colorRampType="INTERPOLATED" minimumValue="-0.34088839999999998" labelPrecision="4" clip="0" maximumValue="0.3005275">
          ...
          <item label="-0.3409" color="#f7fbff" alpha="255" value="-0.34088844060898"/>
          <item label="-0.2575" color="#deebf7" alpha="255" value="-0.257504362761976"/>
          <item label="-0.1741" color="#c6dbef" alpha="255" value="-0.174120284914973"/>
          <item label="-0.0907" color="#9ecae1" alpha="255" value="-0.0907362070679689"/>
          <item label="-0.0074" color="#6baed6" alpha="255" value="-0.00735212922096518"/>
          <item label="0.0760" color="#4292c6" alpha="255" value="0.0760319486260386"/>
          <item label="0.1594" color="#2171b5" alpha="255" value="0.159416026473042"/>
          <item label="0.2364" color="#08519c" alpha="255" value="0.236385944485661"/>
          <item label="0.3005" color="#08306b" alpha="255" value="0.30052754282951"/>
