...
<qgis version="3.28.15-Firenze" hasScaleBasedVisibilityFlag="0" maxScale="0" minScale="1e+08" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" classificationMin="50" type="singlebandpseudocolor" nodataColor="" alphaBand="-1" band="1" classificationMax="9999">
      ...
      <rastershader>
        <colorrampshader classificationMode="2" colorRampType="INTERPOLATED" minimumValue="50" labelPrecision="-10" clip="0" maximumValue="9999">
          <colorramp type="gradient" name="[source]">
            <Option type="Map">
              <Option type="QString" name="color1" value="153,52,4,255"/>
              <Option type="QString" name="color2" value="255,255,212,255"/>
              <Option type="QString" name="direction" value="cw"/>
              <Option type="QString" name="discrete" value="0"/>
              <Option type="QString" name="rampType" value="gradient"/>
              <Option type="QString" name="spec" value="rgb"/>
              <Option type="QString" name="stops" value="0.25;217,95,14,255;rgb;cw:0.5;254,153,41,255;rgb;cw:0.75;254,217,142,255;rgb;cw"/>
            </Option>
          </colorramp>
          <item label="0" color="#993404" alpha="255" value="50"/>
          <item label="0" color="#b54708" alpha="255" value="1155.4444444444443"/>
          <item label="0" color="#d25a0d" alpha="255" value="2260.8888888888887"/>
          <item label="0" color="#e57217" alpha="255" value="3366.333333333333"/>
          <item label="0" color="#f68c23" alpha="255" value="4471.777777777777"/>
          <item label="0" color="#fea73f" alpha="255" value="5577.222222222222"/>
          <item label="0" color="#fec46c" alpha="255" value="6682.666666666666"/>
          <item label="0" color="#fedd96" alpha="255" value="7788.11111111111"/>
          <item label="0" color="#ffeeb5" alpha="255" value="8893.555555555555"/>
          <item label="0" color="#ffffd4" alpha="255" value="9999"/>
