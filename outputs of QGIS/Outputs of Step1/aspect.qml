...
<qgis version="3.28.15-Firenze" hasScaleBasedVisibilityFlag="0" maxScale="0" minScale="1e+08" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" classificationMin="1.27303" type="singlebandpseudocolor" nodataColor="" alphaBand="-1" band="1" classificationMax="360">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader classificationMode="1" colorRampType="INTERPOLATED" minimumValue="1.2730300000000001" labelPrecision="4" clip="0" maximumValue="360">
          ...
          <item label="1.2730" color="#fff5f0" alpha="255" value="1.2730300426483"/>
          <item label="47.9075" color="#fee0d2" alpha="255" value="47.907536137104024"/>
          <item label="94.5420" color="#fcbba1" alpha="255" value="94.54204223155975"/>
          <item label="141.1765" color="#fc9272" alpha="255" value="141.17654832601545"/>
          <item label="187.8111" color="#fb6a4a" alpha="255" value="187.81105442047118"/>
          <item label="234.4456" color="#ef3b2c" alpha="255" value="234.44556051492688"/>
          <item label="281.0801" color="#cb181d" alpha="255" value="281.08006660938264"/>
          <item label="324.1273" color="#a50f15" alpha="255" value="324.12730300426483"/>
          <item label="360.0000" color="#67000d" alpha="255" value="360"/>
