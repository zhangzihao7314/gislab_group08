...
<qgis version="3.28.15-Firenze" hasScaleBasedVisibilityFlag="0" maxScale="0" minScale="1e+08" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" classificationMin="198" type="singlebandpseudocolor" nodataColor="" alphaBand="-1" band="1" classificationMax="2374">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader classificationMode="1" colorRampType="INTERPOLATED" minimumValue="198" labelPrecision="0" clip="0" maximumValue="2374">
          ...
          <item label="198" color="#a6611a" alpha="255" value="198"/>
          <item label="481" color="#c4934d" alpha="255" value="480.88"/>
          <item label="764" color="#e0c482" alpha="255" value="763.76"/>
          <item label="1047" color="#ebdfc0" alpha="255" value="1046.6399999999999"/>
          <item label="1330" color="#ecf2f1" alpha="255" value="1329.52"/>
          <item label="1612" color="#afddd6" alpha="255" value="1612.4"/>
          <item label="1895" color="#71c4b7" alpha="255" value="1895.28"/>
          <item label="2156" color="#34a291" alpha="255" value="2156.4"/>
          <item label="2374" color="#018571" alpha="255" value="2374"/>
